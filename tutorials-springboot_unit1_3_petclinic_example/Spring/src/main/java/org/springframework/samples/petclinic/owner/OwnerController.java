...
class OwnerController {
    ...
    // This method is saving the new user
    //Post method is used to submit the data
    //In this case new user details are being saved
    ...
    public String createDummyData() {
        Owners o1 = new Owners(1, "John", "Doe", "404 Not found", "some numbers","car");
        Owners o2 = new Owners(2, "Jane", "Doe", "Its a secret", "you wish","cat");
        Owners o3 = new Owners(3, "Some", "Pleb", "Right next to the Library", "515-345-41213","meoww");
        Owners o4 = new Owners(4, "Chad", "Champion", "Reddit memes corner", "420-420-4200","meoww");
        Owners o5 = new Owners(5, "Max" , "Min" , "In your mom", "6969699699696","meowwwww");
